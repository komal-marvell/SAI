...
typedef enum _sai_fw_op_state_t
{
    ...
    /** Firmware operational state is firmware is still loading */
    SAI_FW_OP_STATE_LOADING,

    /** Firmware operational state is firmware is still shutting down */
    SAI_FW_OP_STATE_STOPPING,
...
typedef enum _sai_fw_attr_t
{
    ...
    /**
     * @brief Firmware opaque id
     *
     * @type sai_s8_list_t
     * @flags CREATE_ONLY
     * @default empty
     */
    SAI_FW_ATTR_FW_OPAQUE_ID,
