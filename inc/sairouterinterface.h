...
typedef enum _sai_router_interface_attr_t
{
     ...
     *
     * Value Range #SAI_ACL_CAPABILITY_EXTENDED_TYPE_ROUTER_INTERFACE_META_DATA for Ingress stage.
     *
     * @type sai_uint32_t
     * @flags CREATE_AND_SET
     * @default 0
     ...
     *
     * Value Range #SAI_ACL_CAPABILITY_EXTENDED_TYPE_ROUTER_INTERFACE_META_DATA for Egress stage.
     *
     * @type sai_uint32_t
     * @flags CREATE_AND_SET
     * @default 0
